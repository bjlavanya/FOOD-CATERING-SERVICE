...
<head>
    <meta charset="utf-8">
    <title>Royal Admin View Reviews</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="viewreviews.php" class="nav-item nav-link active"><i class="fa fa-comment"></i>&nbsp;&nbsp;&nbsp;View Reviews</a>
                            ...
                            <table class="table table-hover">
								...
								?>
                                    ...
                                    <tr>
										...
										<td><img src="../afterlogin/userreviewimg/<?php echo $customerimage; ?>" alt="slider image" height="90px" width="100px;"></td>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from reviews  where id='".$selectano."'";
	mysqli_query($con,$query1) or die(mysqli_error($con));
	echo "<script> location.href='viewreviews.php'; </script>";
}
?>
