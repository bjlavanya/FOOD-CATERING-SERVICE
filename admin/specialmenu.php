                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post" action="#">
								...
								<div class="mb-3">
                                    ...
                                    <input type="text" name="itemname" class="form-control" id="exampleInputPassword1">
                                </div>
                                <div class="mb-3">
...
if(isset($_POST['add']))
{
	...
	include("config.php");
		...
		$query = "INSERT INTO specialmenu(image,itemname,price)VALUES('".$image."','".$itemname."','".$price."')";
		...
		echo "<script>
			...
			echo "<script> location.href='specialmenu.php'; </script>";
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from specialmenu where id='".$selectano."'";
