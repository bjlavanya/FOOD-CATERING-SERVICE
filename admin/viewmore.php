				       ...
				       <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                               <p>Customer Name: Priya<br>
							   Customer Contact: 9906795660<br>
							   Event Name: Birthday<br>
							   Event Date: 29-12-2023<br>
							   Event Time:Afternoon<br>
							   Address: Vamanjoor Church hall,Vamanjoor<br>
							   Attendees: 200<br>
							   ...
							   Ordered Items: Beverage-Water, Beverage-SoftDrinks, Beverage-FruitJuice, Salads- Corn mixed, Salads- vegetable mixed,
                                Desserts-Gulab Jamun, Desserts-Chocolate icecreams,Sides-Ghee Rice,pulav,Veg cambo,Chicken<br>
							   Message: We prefer spicy food<br>
							   Total Amount: 30000<br>
							   Advance Amount: 30000<br>
							   Status: Paid   
                            </div>
