				       ...
				       <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                               <p>Customer Name: Ankitha<br>
							   Customer Contact: 9905966004<br>
							   Event Name: Wedding<br>
							   Event Date: 24-12-2023<br>
							   Event Time:Afternoon<br>
							   Address: Cordel Hall,Kulshekar<br>
							   Attendees: 1000<br>
							   Order type: Both veg and non veg<br>
							   Ordered Items: Beverage-Water, Beverage-SoftDrinks, Beverage-FruitJuice, Salads- Corn mixed, Salads- vegetable mixed,
                                Desserts-Gulab Jamun, Desserts-Chocolate icecreams,Sides-Ghee Rice,pulav-raitha,Veg cambo,Chicken,Mutton curry,Biryani,<br>
							   Message: We prefer spicy food<br>
							   Total Amount: 80000<br>
							   Advance Amount: 80000<br>
							   Status: Paid   
                            </div>
							<a href="bookinglist.php"><button type="submit" class="btn btn-primary">BACK</button></a>
                        </div>
                    </div>	
