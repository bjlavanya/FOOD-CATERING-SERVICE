...
<head>
    <meta charset="utf-8">
    <title>Royal Admin Slider Image</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
					...
					<a href="addslider.php" class="nav-item nav-link active "><i class="fa fa-sliders" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Add Slider</a>
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post" action="#">
								...
								<div class="mb-3">
                                    <label for="exampleInputPassword1"  class="form-label">ADD CONTENT</label>
...
if(isset($_POST['add']))
{
	...
	include("config.php");
		...
		$query = "INSERT INTO addslider(image,content)VALUES('".$image."','".$content."')";
		...
		echo "<script>
			...
			echo "<script> location.href='addslider.php'; </script>";
...
?>						
	...
	?>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="ourmenu/<?php echo $image; ?>" alt="slider image" height="90px" width="100px;"></td>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from addslider where id='".$selectano."'";
