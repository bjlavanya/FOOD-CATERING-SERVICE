                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">ONLINE PAYMENTS</h6>
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
										...
										<td>30000</td>
										<td>0</td>
										<td><a href="viewmore.php"><button type="submit" class="btn btn-primary">Settle</button></a></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td>Ankitha</td>
										...
										<td>80000</td>
										<td>0</td>
										<td><a href="viewmore1.php"><button type="submit" class="btn btn-primary">Settle</button></a></td>
                                    </tr>
									<tr>
                                        <th scope="row">3</th>
                                        <td>Prajwal</td>
										...
										<td>100000</td>
										<td>0</td>
										<td><a href="viewmore2.php"><button type="submit" class="btn btn-primary">Settle</button></a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
