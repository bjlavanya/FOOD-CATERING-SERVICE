...
<head>
    <meta charset="utf-8">
    <title>Royal Admin Manage Users</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
					...
					<a href="manageusers.php" class="nav-item nav-link active"><i class="fa-solid fa-user"></i>&nbsp;&nbsp;&nbsp;Manage Users</a>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from userregistration  where id='".$selectano."'";
