        ...
        <div class="content">
			...
			if(isset($_GET['up']))
			{
				$up=$_GET['up'];
								...
								include 'config.php';
								$sql1 = "select * from addmenuitem where id='".$up."'";
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">UPDATE MENU</h6>
                            <form method="post" action="#">
                          
								
								<div class="mb-3">
                                    <label for="exampleInputPassword1"  class="form-label">PRICE</label>
                                    <input type="text" class="form-control" value="<?php echo $price; ?>" name="price" id="exampleInputPassword1">
                                </div>
                                
								<div class="mb-3">
                                    <label for="exampleInputPassword1"  class="form-label">DISCRIPTION</label>
                                    <TEXTAREA class="form-control"  name="description" id="exampleInputPassword1"><?php echo $description; ?></textarea>
                                </div>
...
if(isset($_POST['add']))
{
	...
	include("config.php");
		...
		$query = "UPDATE  addmenuitem SET price='".$price."',description='".$description."' where id='".$up."'";
