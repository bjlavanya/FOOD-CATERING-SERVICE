...
<head>
    <meta charset="utf-8">
    <title>Royal Admin Add Course</title>
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="post" action="#">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">ADD COURSE</label>
...
if(isset($_POST['add']))
{
	...
	include("config.php");
		...
		$query = "INSERT INTO addcourse(course)VALUES('".$course."')";
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from addcourse where id='".$selectano."'";
