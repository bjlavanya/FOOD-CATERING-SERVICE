...
<head>
    <meta charset="utf-8">
    <title>Royal Admin Order type</title>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">ORDER TYPE</h6>
                            <form method="post" action="#">
                                
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">ADD ORDER TYPE</label>
                                    <input type="text"  name="ordert" class="form-control" id="exampleInputPassword1">
                                </div>
...
if(isset($_POST['add']))
{
	...
	include("config.php");
		...
		$query = "INSERT INTO ordertype(ordert)VALUES('".$ordert."')";
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from ordertype where id='".$selectano."'";
