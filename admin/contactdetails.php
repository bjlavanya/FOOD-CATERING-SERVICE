...
<head>
    <meta charset="utf-8">
    <title>Royal Admin Contact Details</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
					...
					<a href="contactdetails.php" class="nav-item nav-link active"><i class="fa fa-address-book"></i>&nbsp;&nbsp;&nbsp;Contact Details</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">CUSTOMER CONTACT DETAILS</h6>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from contactus  where id='".$selectano."'";
	mysqli_query($con,$query1) or die(mysqli_error($con));
	echo "<script> location.href='contactdetails.php'; </script>";
}
?>
