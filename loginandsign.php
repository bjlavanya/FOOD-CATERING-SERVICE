			...
			<div class="col align-items-center flex-col sign-up">
				...
				<form method="post" action="#">
					<div class="form sign-up">
						...
						<button type="submit" name="signup" style="background-color:#ff7404;">
							Sign up
						</button>
						</form>
						<p>
...
if(isset($_POST['signup']))
{
	...
	else
	{
		...
		$query = "INSERT INTO userregistration(username,email,phonenumber,password) VALUES('".$username."','".$email."','".$phonenumber."','".$password."')";
			...
			<div class="col align-items-center flex-col sign-in">
				...
				<form method="post" action="#">
					<div class="form sign-in">
						...
						<button type="submit" name="login" style="background-color:#ff7404;">
							Sign in
						</button>
						</form>
						<p>
...
if(isset($_POST['login']))
{
	...
	{
		session_start();
		$_SESSION['royaladmin']=$email;
		$uid=$_SESSION['royaladmin'];
		echo "<script>
